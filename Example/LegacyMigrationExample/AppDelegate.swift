...
class AppDelegate: UIResponder, UIApplicationDelegate {
	...
	// do not give direct access to RootTabBarController on purpose, proper encapsulation
	let rootWireframe: WireframeInterface = WireframeFactory.createRootTabBarControllerWireframe()
